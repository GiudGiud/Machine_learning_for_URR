...
if __name__ == '__main__':
    ...
    figure()
    plot(test_s.imag, test_f.real, "o", label="test imag vs real")
    plot(test_s.imag, test_f.imag, "o", label="test imag vs imag")
    plot(test_s.imag, fitted.real, label="test imag vs fitted real")
    plot(test_s.imag, fitted.imag, label="test imag vs fitted imag")
    legend()
    show()
